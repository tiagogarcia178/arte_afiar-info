  ...
  <body>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <br>
          <h4>Material de corte para o processamento e transformação de peixe</h4>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="fotos/detalhe_carne/lamina-corte-peixe.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4><?php echo($laminas[10]->getTitulo());?></h4>
              <!-- <p>App</p> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="fotos/detalhe_carne/guilhotina.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4><?php echo($laminas[11]->getTitulo());?></h4>
              <!-- <p>Card</p> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <img src="fotos/detalhe_carne/escamador.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4><?php echo($laminas[12]->getTitulo());?></h4>
              <!-- <p>Web</p> -->
