  ...
  <body>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <br>
          <h4>Material de corte para o processamento e transformação de charcutaria</h4>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <img src="fotos/detalhe_carne/lamina_fiambreira.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4><?php echo($laminas[13]->getTitulo());?></h4>
              <!-- <p>Web</p> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="fotos/detalhe_carne/maquina_1.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4><?php echo($laminas[14]->getTitulo());?></h4>
              <!-- <p>App</p> -->
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="fotos/detalhe_carne/maquina_2.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4><?php echo($laminas[14]->getTitulo());?></h4>
              <!-- <p>Card</p> -->
